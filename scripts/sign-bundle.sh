...
# for io.telepat.otto. (See the Pilot catalogue go-live process.)
#
...
#   WRAPPER_IMAGE  wrapper image tag to build/stage (default: pilot-protocol/otto-app:release)
...
#   - publishing the tarball to a URL (tools/release-otto.sh in the private
...
WRAPPER_IMAGE="${WRAPPER_IMAGE:-pilot-protocol/otto-app:release}"
...
script; the private monorepo's tools/release-otto.sh automates step 1):
