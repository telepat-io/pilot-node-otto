/**
 * tsup build config for the io.telepat.otto app.
 *
 ...
 * must not be bundled. `@modelcontextprotocol/sdk` is kept external too so its
 * runtime module resolution (it ships its own dist) is honored. Node built-ins
